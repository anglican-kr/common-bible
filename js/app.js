...
// — settings-ui's bare global call resolves to the global declared in
// js/types.d.ts and bookmark.js's window facade.
window.clearAllCaches = clearAllCaches;

// Read accessor for the books metadata cache. bookmark.js's tree-rendering
// path (Phase 6b) reads `booksCache` to attach `book.short_name_ko` labels
// to bookmark rows; the cache itself lives here because `loadBooks()` (Phase
// 7 territory) is the writer. Migrates out alongside `loadBooks` in Phase 7.
