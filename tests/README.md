...
|---|---|---|---|---|
| **유닛** | `node --test` (의존성 0) | 순수 로직 — 함수 입출력·상태 계산 | **CI 자동** (PR마다) | 26파일 · 877케이스 |
...
| `liturgical-engine.test.js` | 교회력 엔진 계산 계층(ADR-037 §6, 설계서 §4) — computus 1900~2100 권위 표 대조·규칙 7종·절기 스팬·연중 주차(2052 윤년)·주기·음력·기간 축·표 결손 내성. 합성 표만 | 40 |
