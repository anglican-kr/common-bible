...
- 일시: 2026-04-25
- 개정: 2026-04-26 (UI 개선), 2026-05-03 (모바일 행 UX), 2026-06-06 (양방향 스와이프 + full-swipe), 2026-06-06 (분절 산문 절 북마크 통합), 2026-06-06 (장 북마크 선택 삭제), 2026-06-07 (삭제 확인 취소 시 행 닫힘 수정), 2026-06-07 (드롭 위치 지시자 가시화 + 행 아이콘 크기 표준화), 2026-06-10 (스와이프 민감도 일관화)
- 상태: 승인됨
