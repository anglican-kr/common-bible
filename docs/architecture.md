...
| `js/app/views-routing.js`   | 렌더 헬퍼 + Views + 책 이름/헤더 자동 짧게 swap (데이터 패칭→data-fetch.js·오디오→audio-player.js·탭 인디케이터→tabbar.js·라우팅→routing.js·PTR 제거, ADR-034)                          | ~1,350  |
...
- 본문 렌더 + Views + 렌더 헬퍼: `js/app/views-routing.js`
