...
> **해소됨 (2026-07-12).** 150편 전편 편집 완료. 51~77편(`55d8d65`) → 78~103편(`e0138d8`) → 104~148편(`2b36905`)을 차례로 편집해 절을 채우고 교정했고, 마지막에 병합 절 표기를 정규화하며 절 누락 3곳을 보완했다(`cb06fd7`). 확인 시점(2026-08-08) `liturgical/psalter/*.md` 150편에 곧은 따옴표는 0곳이다. 아래 "재확인 필요"로 적어 둔 여섯 편도 모두 이후 편집 범위(78~103 · 104~148)에 들어갔다 — 다만 그 편집이 인쇄본 대조였는지까지는 커밋 기록만으로 단정할 수 없다.
